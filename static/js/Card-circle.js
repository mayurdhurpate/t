...
var Card = (function(window, undefined) {
  ...
  function Card(id, el) {
    ...
    this._desc = $(this._el).find('#desc')[0];  
  ...
  Card.prototype.openCard = function(callback) {
    ...
    var slideTextUp = this._slideTextUp();
    ...
    this._TL.add(slideTextUp, '-=' + slideContentUp.duration() * 0.6);
...
Card.prototype._slideTextUp = function() {

    // Circle.
    var tween = TweenLite.to(this._desc, 0.1, {position: "absolute",
    left: "830px",
    top: "-380px",
    ease: Expo.easeInOut});
...
// /**Slide text**/
//   Card.prototype._slideTexttUp = function() {

//     var tween = TweenLite.to(this._text, 1, {
//       y: 0,
//       clearProps: 'all',
//       ease: Expo.easeInOut
//     });
